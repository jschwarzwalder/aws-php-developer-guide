...
* Get the CORS configuration for a bucket using :sdk-php-api-v3:`GetBucketCors <GetBucketCors>`.
* Set the CORS configuration for a bucket using :sdk-php-api-v3:`PutBucketCors <PutBucketCors>`.
