...
* Create a rule using :sdk-php-api-v3:`PutRule </api-events-2015-10-07.html#putrule>`.
* Add targets to a rule using :sdk-php-api-v3:`PutTargets </api-events-2015-10-07.html#puttargets>`.
* Send custom events to |CWE| using :sdk-php-api-v3:`PutEvents </api-events-2015-10-07.html#putevents>`.
