...
you follow the :iam-ug:`IAM Best Practices <best-practices>` when managing your credentials.
...
.. note::
    ...
    credentials by reading :iam-ug:`AWS Services that Support AWS STS <reference_aws-services-that-work-with-iam>`.
...
your application or project, see :iam-ug:`Scenarios for Granting Temporary Access <id_credentials_temp>` in the AWS STS documentation.
