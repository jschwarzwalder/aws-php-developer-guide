...
``RunTask`` :sdk-php-api-v3:`API </api-ecs-2014-11-13.html#runtask>` operation.
...
For more information regarding ``'assume_role_params'``, see :sdk-php-api-v3:`AssumeRole </api-sts-2011-06-15.html#assumerole>`.
