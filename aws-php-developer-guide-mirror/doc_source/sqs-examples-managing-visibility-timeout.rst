...
.. meta::
   :description: Change the visibility timeout for messages in |SQS|.
...
* Change the visibility timeout of specified messages in a queue to new values, using :aws-php-class:`ChangeMessageVisibilityBatch </api-sqs-2012-11-05.html#changemessagevisibilitybatch>`_.
