...
* Change the visibility timeout of specified messages in a queue to new values, using :sdk-php-api-v3:`ChangeMessageVisibilityBatch <api-sqs-2012-11-05.html#changemessagevisibilitybatch>`.
