...
* Get the website configuration for a bucket using :aws-php-class:`GetBucketWebsite </api-s3-2006-03-01.html#getbucketwebsite>`_.
* Set the website configuration for a bucket using :aws-php-class:`PutBucketWebsite </api-s3-2006-03-01.html#putbucketwebsite>`_.
* Remove the website configuration from a bucket using :aws-php-class:`DeleteBucketWebsite </api-s3-2006-03-01.html#deletebucketwebsite>`_.
